...
- Small learning rate(Gradient Exploding solution)
...
bn_optimizer = torch.optim.Adam(bn_model.parameters(), lr)
nn_optimizer = torch.optim.Adam(nn_model.parameters(), lr)
